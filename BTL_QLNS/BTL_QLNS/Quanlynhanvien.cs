...
namespace BTL_QLNS
{
    public partial class Quanlynhanvien : Form
    {
        ...
        private void Quanlynhanvien_Load(object sender, EventArgs e)// hiển thị database lên dgv
        {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                luongnv = int.Parse(txtLuong.Text);// phương thức chuyển đổi kiểu dữ liệu
            }
            ...
            if (txtMaNv.Text.Trim() == "")
                ...
                nvb.insertNV(txtMaNv.Text, txtTenNv.Text, mtbNgaySinh.Text, txtDiachi.Text, luongnv, cbxPhongban.SelectedValue.ToString(), cbxDuan.SelectedValue.ToString());
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (txtMaNv.Text.Trim() == "")
                ...
                nvb.updateNV(txtMaNv.Text, txtTenNv.Text, mtbNgaySinh.Text, txtDiachi.Text, luongnv, cbxPhongban.SelectedValue.ToString(), cbxDuan.SelectedValue.ToString());
            Quanlynhanvien_Load(sender, e);
        ...
        private void dgvNhanVien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (row >= 0)
            {
                ...
                mtbNgaySinh.Text = dgvNhanVien.Rows[row].Cells[2].Value.ToString();
